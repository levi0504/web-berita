...
# ---------------------------------------------
# 1. INICIALISASI & KONFIGURASI (DISESUAIKAN UNTUK VERCEL)
# ---------------------------------------------
app = Flask(__name__)

# MENGGUNAKAN DB DALAM MEMORI (TIDAK PERMANEN!)
# Database akan hilang setiap kali serverless function di-restart.
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///:memory:' 
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
app.config['SECRET_KEY'] = os.environ.get('SECRET_KEY', 'kunci_rahasia_sangat_aman_tbj_multi_user') 

db = SQLAlchemy(app)
JUDUL_SITUS = 'Berita Terbaru Oleh TBJ (Vercel Edition)'
...
with app.app_context():
    db.create_all()
    # Peringatan: Data akan hilang karena menggunakan DB in-memory.
    # Akun admin harus dibuat melalui /register setelah deployment.

# ---------------------------------------------
# 3. TEMPLATE HTML (DISINGKAT: CSS/HTML TIDAK BERUBAH TOTAL)
# ---------------------------------------------
...
<body>
    ...
    <div class="footer">
        <p>© 2025 {{ judul_situs }}. Powered by Flask.</p>
    </div>
...
def register():
    ...
    if form.validate_on_submit():
        ...
        if User.query.filter_by(username=username).first():
            ...
            # Akun pertama yang dibuat akan dijadikan ADMIN, sisanya PENULIS
...
# ---------------------------------------------
# 7. JALANKAN APLIKASI (DIHAPUS UNTUK VERCEL)
# ---------------------------------------------
